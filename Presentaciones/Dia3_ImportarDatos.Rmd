...
> Especie: *Homo sapiens*, Alineamiento: STAR, Conteo: STAR.
...
- Script [`VisualizacionDatos.R`](https://github.com/EveliaCoss/RNAseq_classFEB2025/blob/main/Practica_Dia3/scripts/VisualizacionDatos.R):

  **8)** Visualización de los datos

- Script [`GOterms_analysis.R`](https://github.com/EveliaCoss/RNAseq_classFEB2025/blob/main/Practica_Dia4/scripts/GOterms_analysis.R):
...
## Actividad
#### Iniciar una sesión interactiva en el clúster y abrir R

- 1) Solicitar un **nodo interactivo** con `qlogin` (por defecto, asigna 2GB de RAM)
- 2) Cargar el módulo de R versión 4.0.2
- 3) Iniciar R
...
Para esta clase usaremos los datos de *Homo sapiens* 
