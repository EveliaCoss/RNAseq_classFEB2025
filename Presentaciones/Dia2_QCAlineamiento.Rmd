...
[Licenciatura en Ciencias Genómicas](https://www.enesjuriquilla.unam.mx/?page_id=2136) @ ENES-J UNAM
...
- Bioproject: PRJNA1051620, [NHI](https://www.ncbi.nlm.nih.gov/bioproject/PRJNA1051620) y [EBI](https://www.ebi.ac.uk/ena/browser/view/PRJNA1051620)
...
Este proyecto cuenta con 75 Biosamples (SRA Experiments) de las cuales se seleccionaron las del Dia 7 posterior a la vacuna de COVID-19 (BNT162b2 SARS-CoV-2) en pacientes con Lupus. 
...
# filter 
knitr::kable(metadata_db %>% filter(timepoint == 7), caption = 'Informacion de la metadata')
```
...
```{bash, eval = F}
cd /mnt/Guanina/bioinfo25/data/Clase_RNASeq2025/scripts/
